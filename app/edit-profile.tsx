    ...
    <SafeAreaView edges={['top', 'bottom']} style={{ flex: 1, backgroundColor: T.bg }}>
      ...
      >
        ...
        <View style={{
          ...
          <Text style={{ color: T.ink, fontFamily: 'Nunito_700Bold', fontSize: 17 }}>Editar Perfil</Text>
          <ScalePress
            onPress={handleSave} disabled={!canSave}
            style={{
              borderRadius: 16, paddingHorizontal: 16, paddingVertical: 10,
              backgroundColor: canSave ? darkCardBg : T.sunken,
            }}
          >
            {saving
        ...
        <View style={{ alignItems: 'center', paddingVertical: 24 }}>
          <ScalePress onPress={handlePickPhoto}>
            <PetPhoto
              ...
              nome={nome}
              size={120}
              style={{ borderWidth: 3, borderColor: T.rule }}
            />
            <View style={{
              ...
              <Camera size={20} color={T.ink} strokeWidth={2} />
            </View>
          </ScalePress>
          <Text style={{ color: T.ink3, fontSize: 12, marginTop: 12 }}>Toque para alterar a foto</Text>
        </View>

        <View style={{ paddingHorizontal: 20, gap: 20 }}>
          {/* Nome */}
          <View>
            <Text style={{ color: T.ink2, fontFamily: 'Nunito_700Bold', fontSize: 14, marginBottom: 8 }}>
          ...
          {/* Tipo */}
          <View>
            <Text style={{ color: T.ink2, fontFamily: 'Nunito_700Bold', fontSize: 14, marginBottom: 10 }}>
              Tipo de animal
            </Text>
                ...
                return (
                  <ScalePress
                    ...
                    style={{
                      ...
                      borderWidth: 2, borderColor: selected ? darkCardBg : T.rule,
                      ...(Platform.OS === 'android' ? { elevation: selected ? 3 : 1 } : {}),
                    }}
                  >
                    <Text style={{ fontSize: 24 }}>{opt.emoji}</Text>
                    <Text style={{ fontSize: 12, fontWeight: '600', color: selected ? '#ffffff' : T.ink2 }}>
                      {opt.label}
                    </Text>
                  </ScalePress>
                );
          ...
          {/* Data de nascimento */}
          <View>
            <Text style={{ color: T.ink2, fontWeight: '600', fontSize: 14, marginBottom: 8 }}>
              Data de nascimento <Text style={{ color: T.ink3, fontWeight: '400' }}>(opcional)</Text>
            </Text>
            <TextInput
          ...
          <View>
            <Text style={{ color: T.ink2, fontWeight: '600', fontSize: 14, marginBottom: 8 }}>
              Anotações gerais <Text style={{ color: T.ink3, fontWeight: '400' }}>(opcional)</Text>
            </Text>
            <TextInput
              value={notes}
          ...
          <View style={{
            ...
            borderWidth: 1, borderColor: ACTIONS_V3.comida.tintD,
            borderRadius: 16, paddingHorizontal: 16, paddingVertical: 12,
            flexDirection: 'row', alignItems: 'flex-start', gap: 12,
          }}>
            <Text style={{ fontSize: 16 }}>🔒</Text>
            <Text style={{ color: ACTIONS_V3.comida.primary, fontSize: 12, flex: 1, lineHeight: 20 }}>
