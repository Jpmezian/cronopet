...
-- ─── H-1a: is_group_member com search_path fixo ──────────────
...
-- ─── H-1b: handle_new_user (trigger de signup) com search_path ──
-- Definição original criada via dashboard sem search_path. Recriada
-- aqui idêntica + set search_path. Trigger continua bind-ada
-- (after insert on auth.users) — não precisa recriar o trigger.
